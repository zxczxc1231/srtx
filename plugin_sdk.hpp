...
public:
	...
	void set_skin( uint32_t id ) { this->set_gear(0); this->set_skin(id, this->get_model()); }
	...
	virtual void reserved31() = 0;
	virtual void reserved32() = 0;
	virtual void reserved33() = 0;
	virtual void reserved34() = 0;
	virtual void reserved35() = 0;
	virtual void reserved36() = 0;
	virtual void reserved37() = 0;
	virtual void reserved38() = 0;
	virtual void reserved39() = 0;
	

	virtual uint32_t get_skin() = 0;
	virtual void set_gear(uint32_t index) = 0;
...
public:
    ...
    virtual void set_max_zoom(float zoom)=0;
};
...
public:
    ...
    virtual const char *translate_string(const char *str) = 0;
};
...
template < >
struct event_handler<events::on_send_chat>
{
	static void add_callback(void(*callback)(std::wstring& message, int type, bool* process), event_prority prority = event_prority::medium) { plugin_sdk->get_event_handler_manager()->add_callback(events::on_send_chat, (void*)callback, prority); }
	static void remove_handler(void(*callback)(std::wstring& message, int type, bool* process)) { plugin_sdk->get_event_handler_manager()->remove_callback(events::on_send_chat, (void*)callback); }
};
